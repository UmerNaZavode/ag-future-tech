        ...
        <ul class="bordered-grid bordered-grid--4-cols container">
          <li class="bordered-grid__item">
            <div class="contacts-card">
              ...
              <div class="contacts-card__body">
                <a class="contacts-card__link button button--dark-gray" href="mailto:contact@ai-podcasts.com">
                  <span class="icon icon--yellow-arrow">contact@ai-podcasts.com</span>
                </a>
                <a class="contacts-card__link button button--dark-gray" href="tel:+11234567890">
          ...
          <li class="bordered-grid__item">
            <div class="contacts-card">
              ...
              <div class="contacts-card__body">
                <address class="contacts-card__address">Address: 123 AI Tech Avenue, Techville, 54321
                </address>
                <a class="contacts-card__link button button--dark-gray" href="/">
        ...
        <div class="list">
            ...
            <div class="card container">
              <div class="card__preview">
                <div class="card__preview-main">
                  <img class="card__preview-icon" src="/src/images/contacts/icon-1.svg" alt="" width="80" height="80" loading="lazy" />
          ...
          <div class="list__item">
            <div class="card container">
              <div class="card__preview">
                <div class="card__preview-main">
                  <img class="card__preview-icon" src="/src/images/contacts/icon-2.svg" alt="" width="80" height="80" loading="lazy" />
                  <div class="card__preview-info">
                    ...
                    <div class="accordion__content" id="faq-1" role="definition">
                      <div class="accordion__content-inner">
                        <div class="accordion__content-body">
                          <p>AI stands for Artificial Intelligence, which refers to the simulation
                            of human intelligence in machines. It enables them to perform tasks
                            like problem-solving, learning, and decision-making.</p>
                        </div>
                      </div>
                    </div>
                  </div>
